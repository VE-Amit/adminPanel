        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="white-box">
                <div class="col-md-3 col-sm-4 col-xs-6 pull-right">
                    <a href="{{route('admin.category.create')}}" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Add</a>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="display: flex; font-weight:500;">
                                    <a href="{{route('admin.category.edit', $category->id)}}" class="btn-xs">Edit</a>
