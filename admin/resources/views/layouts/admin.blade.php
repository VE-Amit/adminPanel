...
<body class="fix-header">
    ...
    @if ($message = Session::get('success'))
        <script>
            success('Success', '<?php echo $message ?>');
        </script>
    @endif
    ...
    @if (session()->has('message'))
        <script>
            popup('Success', '<?php echo $message ?>');
        </script>
    @endif
    <!-- ============================================================== -->
    <!-- Preloader -->
    ...
    <div id="wrapper">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" data-toggle="dropdown" class="btn btn-default dropdown-toggle">
                            <img src="https://ui-avatars.com/api/?name=John+Doe&rounded=true" alt="user-img" style="height:36px; width:36px; object-fit:cover;" class="img-circle"><b class="hidden-xs">{{Auth::User()->name ?? 'Admin'}}</b>
                        </a>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu" style="padding: 70px 0 0;">
                    <li><a href="{{route('admin.dashboard')}}" class="waves-effect"><i class="fa fa-tachometer fa-fw" aria-hidden="true"></i>{{__('Dashboard')}}</a></li>
                    <li><a href="{{route('admin.user.index')}}" class="waves-effect"><i class="fa fa-users fa-fw" aria-hidden="true"></i>{{__('Users')}}</a></li>
                    <li><a href="{{route('admin.subs.index')}}" class="waves-effect"><i class="fa fa-usd fa-fw" aria-hidden="true"></i>{{__('Subscriptions')}}</a></li>
                    <li><a href="{{route('admin.company.index')}}" class="waves-effect"><i class="fa fa-building fa-fw" aria-hidden="true"></i>{{__('Companies')}}</a></li>
                    <li><a href="{{route('admin.category.index')}}" class="waves-effect"><i class="fa fa-database fa-fw" aria-hidden="true"></i>{{__('Categories')}}</a></li>
                </ul>
        ...
        <div id="page-wrapper">
            @yield('content')
            <!-- /.container-fluid -->
            <footer class="footer text-center"> AdminPanel </footer>
        </div>
        <!-- ============================================================== -->
        <!-- End Page Content -->
        <!-- ============================================================== -->
